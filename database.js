...
// Use environment variable for path if available (for Render persistence), otherwise local
const dbPath = process.env.DATABASE_PATH || path.join(__dirname, 'funeral_home.db');
